...
class Report extends CI_Controller
{
    ...
    function __construct()
    {
        parent::__construct();
        check_not_login();
        $this->load->model(['sale_m', 'item_m', 'supplier_m', 'toko_m']);
    }
    ...
    public function stockDaily()
    {
        ...
        $url = 'stock/getstockdaily?whs_code=' . $whs_code;
        $result = get_curl($url);
        $stock = array();
        ...
        $this->template->load('template', 'report/stock_daily', $data);
    }

    public function stockDailyDetail()
    {
        $stock = array();
        $get = $this->input->get();
        $whs_code = $get['whs_code'];
        $date = $get['date'];
        $url = 'stock/getstockdailydetail?whs_code=' . $whs_code . '&date=' . $date;
        $result = get_curl($url);
        // var_dump($result);
        ...
        $this->template->load('template', 'report/stock_daily_detail', $data);
    }
}
