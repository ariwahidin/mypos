...
$excel->getProperties()->setCreator('Pandurasa Kharisma')
    ...
    ->setTitle("DATA STOCK OUT")
    ->setSubject("DATA STOCK OUT")
    ->setDescription("DATA STOCK OUT")
    ->setKeywords("DATA STOCK OUT");
...
$excel->setActiveSheetIndex(0)->setCellValue('B3', "BARCODE"); // Set kolom A3 dengan tulisan "NO"
$excel->setActiveSheetIndex(0)->setCellValue('C3', "DESC"); // Set kolom A3 dengan tulisan "NO"
$excel->setActiveSheetIndex(0)->setCellValue('D3', "QTY"); // Set kolom A3 dengan tulisan "NO"
$excel->setActiveSheetIndex(0)->setCellValue('E3', "EXPIRED DATE"); // Set kolom A3 dengan tulisan "NO"
$excel->setActiveSheetIndex(0)->setCellValue('F3', "INFO"); // Set kolom A3 dengan tulisan "NO"
$excel->setActiveSheetIndex(0)->setCellValue('G3', "CREATED"); // Set kolom A3 dengan tulisan "NO"
...
foreach ($stock_out->result() as $data) {
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('E' . $numrow, $data->expired_date);
    $excel->setActiveSheetIndex(0)->setCellValue('F' . $numrow, $data->info);
    $excel->setActiveSheetIndex(0)->setCellValue('G' . $numrow, $data->created);
    ...
    $excel->getActiveSheet()->getColumnDimension('G')->setWidth(12.43);
...
$excel->getActiveSheet(0)->setTitle("STOCK OUT");
$excel->setActiveSheetIndex(0);
// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Stock Out '.$toko->row()->nama_toko.' '. date('dmYHis'). '.xlsx"'); // Set nama file excel nya
