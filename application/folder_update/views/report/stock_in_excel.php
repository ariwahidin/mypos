...
$excel->getProperties()->setCreator('Pandurasa Kharisma')
    ...
    ->setTitle("DATA STOCK IN")
    ->setSubject("DATA STOCK IN")
    ->setDescription("DATA STOCK IN")
    ->setKeywords("DATA STOCK IN");
...
$excel->setActiveSheetIndex(0)->setCellValue('B3', "DOCNUM"); // Set kolom A3 dengan tulisan "NO"
...
$excel->setActiveSheetIndex(0)->setCellValue('E3', "QTY"); // Set kolom A3 dengan tulisan "NO"
...
foreach ($stock_in->result() as $data) {
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('B' . $numrow, $data->docnum);
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('F' . $numrow, $data->expired_date);
...
$excel->getActiveSheet(0)->setTitle("STOCK IN");
$excel->setActiveSheetIndex(0);
// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Stock In '.$toko->row()->nama_toko.' '. date('dmYHis'). '.xlsx"'); // Set nama file excel nya
